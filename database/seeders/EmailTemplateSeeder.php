    ...
    public function run(): void
    {
        $templates = [
            ...
            [
                ...
                'placeholders_disponibles' => ['nom', 'prenom', 'email', 'date_debut', 'date_fin', 'direction_service', 'heure_presentation', 'tuteur_nom', 'code_suivi'],
            ],
            [
                ...
                'placeholders_disponibles' => ['nom', 'prenom', 'code_suivi', 'direction_service', 'tuteur_nom', 'date_debut', 'date_fin'],
            ],
            [
                'slug' => 'induction_rh',
                'nom' => 'Induction RH',
                ...
                'placeholders_disponibles' => ['nom', 'prenom', 'code_suivi', 'direction_service', 'tuteur_nom'],
            ],
            [
                'slug' => 'debut_stage',
                'nom' => 'Début du stage',
            ...
            [
                ...
                'placeholders_disponibles' => ['nom', 'prenom', 'code_suivi', 'tuteur_nom', 'note_evaluation', 'appreciation_tuteur'],
            ],
            [
