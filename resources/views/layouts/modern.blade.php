        ...
        <div class="footer-content">
            ...
            <div class="footer-section">
                ...
                <div class="mt-4 space-y-2">
                    ...
                    <div class="text-xs text-bracongo-gray-500">
                        <a href="/admin" class="hover:text-bracongo-gray-300 transition-colors duration-300">Administration</a>
                    </div>
                </div>
            </div>
        </div>
